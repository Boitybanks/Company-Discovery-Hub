      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-indigo-400">Opportunities</a></li>
              <li><a href="#" className="hover:text-indigo-400">Scholarships</a></li>
              <li><a href="#" className="hover:text-indigo-400">AI Mentor</a></li>
            </ul>
          </div>
          <div>
            <h5 className="font-bold text-white mb-3">For Companies</h5>
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-indigo-400">Post a Job</a></li>
              <li><a href="#" className="hover:text-indigo-400">Premium Profiles</a></li>
              <li><a href="#" className="hover:text-indigo-400">Partnerships</a></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center text-sm">
          <p>&copy; {new Date().getFullYear()} Comp@ny. All rights reserved.</p>
